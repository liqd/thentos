...
user1 = User "name1" (encryptTestSecret "passwd") "em@il" Map.empty Map.empty
user2 = User "name2" (encryptTestSecret "passwd") "em38@il" Map.empty Map.empty
user3 = User "name3" (encryptTestSecret "3") "3" Map.empty Map.empty
user4 = User "name4" (encryptTestSecret "4") "4" Map.empty Map.empty
user5 = User "name5" (encryptTestSecret "5") "5" Map.empty Map.empty
